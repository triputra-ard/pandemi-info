    ...
    <div class="page-wrapper">
      <div class="container">
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              <h1 class="text-center display-1 animated flash infinite d-none d-sm-none d-md-none d-xl-block d-lg-block">403 : Access Denied</h1>
              <h4 class="text-center display-1 animated flash infinite d-block d-sm-block d-md-block d-xl-none d-lg-none">403 <small>Access Denied</small></h4>
              <br>
              <h3 class="text-center">Oh.. Anda tidak mempunyai akses untuk melakukan ini <a class="text-danger" href="#" onclick="Return()">&larr; Bawa saya kembali</a></h3>
            </div>
          </div>
        </div>
      </div>
